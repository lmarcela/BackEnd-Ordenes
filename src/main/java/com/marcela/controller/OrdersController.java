...
public class OrdersController {
	...
	public List<Order> getOrderCustomerDates(@PathVariable int customerId, @PathVariable Date fechaInicio,
			...
			if (unidades == 0) {
				...
				if (productIds.length == productQuantitys.length) {
					...
					if (esValido) {
						...
						// return "ERROR: Al menos uno de los productos que indico no estan permitidos
						// para el cliente.";
						return null;
					}
				} else {
				...
				// return "ERROR: Se supero el maximo de unidades permitidas. El maximo
				// permitido es 5 y su orden tiene "+unidades+" unidades.";
				return null;
			}
