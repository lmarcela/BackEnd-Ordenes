...
public interface OrderRepository extends CrudRepository<Order,Integer>{
	...
	public List<Order> findByCustomerFechas (@Param("id") int customerId, @Param("fechaInicio") Date fechaInicio, @Param("fechaFin") Date fechaFin);
	...
	public List<Order> findByCustomerUltimoMes (@Param("id") int customerId, @Param("fechaActual") Date fechaActual, @Param("ultimoMes") Date ultimoMes);
